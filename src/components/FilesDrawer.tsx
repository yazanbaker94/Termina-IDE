    ...
    <div className="files-drawer">
      <div className="files-drawer-header">
        ...
        <div className="files-drawer-actions">
          {!!projectName && (
            <button className="files-drawer-action-btn" onClick={onRefreshTree} title="Refresh explorer">
              <RefreshCw size={12} />
            </button>
          )}
          <button className="files-drawer-action-btn" onClick={onClose} title="Close">
            <X size={14} />
          </button>
        </div>
      </div>
      ...
      {projectName && (
        <div className="files-drawer-filter">
          ...
          <input
            className="files-drawer-filter-input"
            type="text"
          ...
          />
          {filter && (
            <button className="files-drawer-filter-clear" onClick={() => setFilter('')}>
              <X size={10} />
            </button>
          )}
        </div>
      ...
      {!projectName ? (
        <div className="files-drawer-empty">
          ...
          <button className="files-drawer-open-btn" onClick={onOpenFolder}>
            <FolderOpen size={14} />
